...
-(void) clearValueViewByKey: (NSString*)valueViewKey
{
    ...
    [SSViewHelper iterateSubViewRecursively: valueView1 subViewClazz:[UITextField class] handler:^BOOL(UIView *view) {
        UITextField* tx = (UITextField*)view;
        tx.text = nil;
        return NO;
    }];
...
-(void)Creat
{
    ...
    dd1 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 13, 165, 31)];
    dd1.textField.placeholder = @"標準H型鋼型號";
    __weak ProcessingRolledSteelController* weakSelf = self;
    ...
    dd1.tableArray = arr1;
    ValueView* valueView1 = [SSViewHelper getValueView: @"valueView1" inView:contentView];
    [valueView1 addSubview:dd1];
    
    
    dd2 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 8, 165, 31)];
    dd2.textField.placeholder = @"等邊矩形管型號";
    dd2.didSelectIndexAction = ^void(DropDown1* view , NSIndexPath* indexPath)
    {
        
        weakSelf.dd3.textField.enabled = NO;
        
        [weakSelf rectanglepipeselect];
    ...
    dd2.tableArray = arr2;
    ValueView* valueView2 = [SSViewHelper getValueView: @"valueView2" inView:contentView];
    [valueView2 addSubview:dd2];
    
    
    dd3 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 42, 165, 31)];
    dd3.textField.placeholder = @"不等邊矩形管型號";
    dd3.didSelectIndexAction = ^void(DropDown1* view , NSIndexPath* indexPath)
    {
        
        weakSelf.dd2.textField.enabled = NO;
    ...
    dd3.tableArray = arr3;
    valueView2 = [SSViewHelper getValueView: @"valueView2" inView:contentView];
    [valueView2 addSubview:dd3];
    
    
    dd4 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 8 , 165, 31)];
    dd4.textField.placeholder = @"圓鋼型號";
    dd4.didSelectIndexAction = ^void(DropDown1* view , NSIndexPath* indexPath)
    {
        [weakSelf circleselect];
    ...
    dd4.tableArray = arr4;
    ValueView* valueView4 = [SSViewHelper getValueView: @"valueView4" inView:contentView];
    [valueView4 addSubview:dd4];
    
    
    
    dd5 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 8, 165, 31)];
    dd5.textField.placeholder = @"C型鋼型號";
    dd5.didSelectIndexAction = ^void(DropDown1* view , NSIndexPath* indexPath)
    {
        [weakSelf csteelselect];
    ...
    dd5.tableArray = arr5;
    ValueView* valueView5 = [SSViewHelper getValueView: @"valueView5" inView:contentView];
    [valueView5 addSubview:dd5];
    
    
    dd6 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 8, 165, 31)];
    ...
    dd6.tableArray = arr6;
    ValueView* valueView6 = [SSViewHelper getValueView: @"valueView6" inView:contentView];
    [valueView6 addSubview:dd6];
    
    
    dd7 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 8, 165, 31)];
    dd7.textField.placeholder = @"槽鋼型號";
    dd7.didSelectIndexAction = ^void(DropDown1* view , NSIndexPath* indexPath)
    {
        [weakSelf channelselect];
        
        NSArray* textFields = @[weakSelf.channel,weakSelf.channelloss,weakSelf.channelpcs,weakSelf.channelname,weakSelf.channelm];
        [SSViewHelper clearTextField: textFields];
    };;
    ...
    dd7.tableArray = arr7;
    ValueView* valueView7 = [SSViewHelper getValueView: @"valueView7" inView:contentView];
    [valueView7 addSubview:dd7];
    
    dd8 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 8, 165, 31)];
    dd8.textField.placeholder = @"Z型鋼型號";
    dd8.didSelectIndexAction = ^void(DropDown1* view , NSIndexPath* indexPath)
    {
        [weakSelf zsteelselect];
    ...
    dd8.tableArray = arr8;
    ValueView* valueView8 = [SSViewHelper getValueView: @"valueView8" inView:contentView];
    [valueView8 addSubview:dd8];
    
    
    dd9 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 8, 165, 31)];
    dd9.textField.placeholder = @"等邊角鋼型號";
    dd9.didSelectIndexAction = ^void(DropDown1* view , NSIndexPath* indexPath)
    {
        weakSelf.dd10.textField.enabled = NO;
        
        [weakSelf angleselect];
    ...
    dd9.tableArray = arr9;
    ValueView* valueView9 = [SSViewHelper getValueView: @"valueView9" inView:contentView];
    [valueView9 addSubview:dd9];
    
    dd10 = [[DropDown1 alloc] initWithFrame:CanvasRect(575, 42, 165, 31)];
    dd10.textField.placeholder = @"不等邊角鋼型號";
    dd10.didSelectIndexAction = ^void(DropDown1* view , NSIndexPath* indexPath)
    {
        weakSelf.dd9.textField.enabled = NO;
...
-(void) circleselect
{
    ...
    value = [ddDictionary[@"dd4"][oneTextField.text] doubleValue];
...
-(void)hsteelsymmetryselect
{
    ...
    value = [ddDictionary[@"dd1"][oneTextField.text] doubleValue];
...
-(void)rectanglepipeselect
{
    ...
    if (![oneTextField.text isEqualToString: @""]) {
        value = [ddDictionary[@"dd2"][oneTextField.text] doubleValue];
    } else {
        value = [ddDictionary[@"dd3"][twoTextField.text] doubleValue];
    }
...
-(void)angleselect
{
    ...
    double value = 0;
    if (![oneTextField.text isEqualToString: @""]) {
        value = [ddDictionary[@"dd9"][oneTextField.text] doubleValue];
    } else {
        value = [ddDictionary[@"dd10"][twoTextField.text] doubleValue];
    }
    anglekg.value = value;
...
-(void)csteelselect
{
    ...
    value = [ddDictionary[@"dd5"][oneTextField.text] doubleValue];
...
-(void)zsteelselect
{
    ...
    value = [ddDictionary[@"dd8"][oneTextField.text] doubleValue];
...
-(void)girderselect
{
    ...
    value = [ddDictionary[@"dd6"][oneTextField.text] doubleValue];
...
-(void)channelselect
{
    ...
    value = [ddDictionary[@"dd7"][oneTextField.text] doubleValue];
